...
- **README-first aircraft docs** — Aircraft-specific notes should live in each aircraft `README.md`.
...
**[Installation Guide](getting-started/installation.md)** · [Aircraft READMEs](aircraft/index.md) · [Development Notes](getting-started/development.md)
