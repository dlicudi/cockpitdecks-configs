...
2. **This repository**
   Supplies aircraft configs, supporting config assets, and documentation sources.
...
1. Treat `decks/` as the primary configuration source.
...
4. Prefer updating the source config when the same issue appears in multiple aircraft pages.
